...
This lesson is just an overview to get you started. We'll dig deeper while coding an actual project.
...
To check if something is a string, you can use the `typeof` operator.
...
To check if something is a number, you can use the `typeof` operator.
...
To check if something is a boolean, you can use the `typeof` operator.
...
To check if something is `undefined` or `null`, you can use the strict equality operator (`===`).
