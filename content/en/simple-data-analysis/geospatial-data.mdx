...
As we did in the previous lesson, create a new folder on your computer, open it with VS Code, and run the following command in the terminal: `deno run -A jsr:@nshiab/setup-data-project`
...
![A screenshot showing VS Code after running setup-data-project.](/assets/simple-data-analysis/geospatial-data/setup.png)
...
We can also save a chart using [Plot](https://github.com/observablehq/plot), which was installed automatically with SDA by `setup-data-project`.
...
You are also ready to tackle [Wrangling Statistics Canada Census data 🇨🇦](/data-projects/stats-can-census), where you’ll put these tabular and geospatial techniques into practice on a large real-world dataset.
