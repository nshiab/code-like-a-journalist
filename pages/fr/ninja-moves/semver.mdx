...
It's much safer to update to a minor version, since you shouldn't have to recode parts of your project. But this is code, and maintainers are humans, so there are always some surprises! 😬
