...
The syntax follows this structure: the selector comes first, followed by property-value pairs enclosed in curly brackets. For example, the code below instructs the browser to apply bold formatting to all `p` elements on the page.
