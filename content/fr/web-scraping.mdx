...
Je pars du principe que vous avez terminé les sections précédentes de ce cours. Nous aborderons les structures HTML nécessaires à l’extraction de données au fur et à mesure.
...
Notez que cet exemple vient du projet [Simulateur boursier 📈](/fr/stock-market-simulator). Allez le voir si vous voulez en savoir plus sur l'utilisation d'API non documentées dans vos projets.
