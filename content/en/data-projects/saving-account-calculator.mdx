...
Welcome to your first coding project! Note that I expect you to have completed the lessons in the *TypeScript fundamentals* section. If you haven’t, [start here](/first-steps/setup).
...
- How much could I make by putting my money into a savings account?
