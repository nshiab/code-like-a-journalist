...
<Callout type="warning" emoji="⚠️">
  Depuis la prise de cette capture d'écran, l'URL de l'API du Service météorologique du Canada a changé. Assurez-vous de prendre l'URL indiquée dans le bloc de code donné au début de la leçon.
</Callout>
