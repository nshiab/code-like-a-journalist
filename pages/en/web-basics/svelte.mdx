...
Just to make sure that our changes don't break our code with SDA, you can stop your terminal (`CTRL` + `C`) and run `deno task sda`. You should see your table in your terminal and the map of the whole country saved as a PNG. This is wonderful! We are using the same function to draw our map with SDA and with Svelte!
...
After a few seconds, you should see files in the `build` folder. This is your website! You can now host these files on a server to show the world your work!
