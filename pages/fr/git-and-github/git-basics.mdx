...
Notez que je vais vous montrer comment utiliser Git dans le terminal. Je pense que c'est important pour comprendre comment cet outil fonctionne. Mais par la suite, vous pourrez choisir et installer l’une des nombreuses extensions Git disponibles pour VS Code.
...
Et un dernier conseil : considérez toujours vos messages de commit comme publics. Vous ne savez jamais quand vous demanderez de l’aide à un collègue ! Et si vous travaillez sur un projet en code ouvert, eh bien… tout le monde verra vos commits. 😅
