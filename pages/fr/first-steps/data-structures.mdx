...
Il est également possible de passer un argument pour trier la liste d'une manière spécifique, comme par ordre décroissant, mais nous aborderons cela plus tard.
