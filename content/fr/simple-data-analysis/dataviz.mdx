...
![Une capture d'écran montrant VS Code après l'exécution de setup-sda.](/assets/simple-data-analysis/dataviz/setup.png)
...
- Nous formatons les libellés de l'axe des y avec la fonction `formatNumber` de la librairie [journalism](https://github.com/nshiab/journalism). J'ai créé cette librairie pour fournir des fonctions utilitaires générales. Elle est automatiquement installée avec `setup-sda`.
