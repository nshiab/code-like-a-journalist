...
In this lesson, we will take the final code from the [Savings account calculator 💸](/saving-account-calculator) and refactor it. If you haven’t completed this project, do it first! I also expect that you have completed all of the lessons in the **First steps** 🧑‍🎓 section.
