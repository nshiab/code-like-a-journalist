...
This is why I suggest typing every line of code yourself as you work through this course. If something doesn't make sense or a lesson isn't clear enough, you can use an AI helper to explain it in more detail. Typing the code yourself will help you learn and understand the lessons, even if, in your daily job, you will probably use AI to write code as well, just like I do! 🦾
...
But over time, I’ve come to enjoy using [TypeScript](https://www.typescriptlang.org/) even more. TypeScript is built on JavaScript, the programming language that runs in web pages, and adds a type system that makes complex code and data easier to understand and manage. One of its biggest advantages is that you can use the same language to build websites, analyze data, create interactive visualizations, and scrape information from the web.
...
So, if I were to recommend a language today, it would be TypeScript. That is what I want to teach you here: TypeScript fundamentals first, followed by complete data workflows and projects with SDA. 😁
