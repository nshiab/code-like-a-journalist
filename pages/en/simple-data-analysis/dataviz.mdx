...
This lesson assumes you've already completed the [Tabular data](/simple-data-analysis/tabular-data) and [Geospatial data](/simple-data-analysis/geospatial) lessons.
...
Of course, these visualizations are static. There’s no user interaction since they are saved as images.

But don’t worry! We’ll reuse everything we’ve learned here to create interactive data visualizations on the web in a future lesson! 😁
