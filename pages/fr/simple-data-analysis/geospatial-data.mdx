...
description: In this lesson, we learn how to open, process, join, and visualize geospatial data.
---
...
GeoJSON is a widely used format for geospatial data. It typically consists of an object that stores an array of `features`. Each feature has a geometry (which contains latitude and longitude coordinates or equivalent) and properties (which store metadata).
