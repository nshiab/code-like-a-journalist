...
Avant de commencer, assurez-vous d’avoir complété les sections précédentes, en particulier **1. Premiers pas 🧑‍🎓**, **2. Aller plus loin 🚀**, ainsi que les leçons sur le [HTML](/web-basics/html) et [CSS](/web-basics/css).
