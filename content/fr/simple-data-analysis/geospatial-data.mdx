...
![Une capture d'écran montrant VS Code après l'exécution de setup-data-project.](/assets/simple-data-analysis/geospatial-data/setup.png)
...
Nous pouvons également enregistrer un graphique en utilisant [Plot](https://github.com/observablehq/plot), qui a été installée automatiquement avec SDA par `setup-data-project`.
