...
I expect you to have completed the previous sections of this course. We’ll focus on the HTML structures needed for data extraction as we encounter them.
...
Note that this example comes from the [Stock market simulator 📈](/en/stock-market-simulator) project. Check it out if you want more about using undocumented APIs in your projects.
