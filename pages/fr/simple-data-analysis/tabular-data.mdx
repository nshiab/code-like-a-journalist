...
La librairie est publiée sur [JSR](https://jsr.io/@nshiab/simple-data-analysis), et vous pouvez l'installer en exécutant `deno add @nshiab/simple-data-analysis`.
