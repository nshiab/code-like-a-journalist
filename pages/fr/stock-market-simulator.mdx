...
<Callout type="warning" emoji="⚠️">
  Yahoo Finance bloque parfois les requêtes provenant de scripts. Si vous obtenez une erreur en exécutant le code ci-dessus, essayez d'ajouter un _header_ pour simuler un navigateur.
