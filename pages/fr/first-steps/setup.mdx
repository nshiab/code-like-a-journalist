...
4. Dans l'onglet `main.ts`, tapez `console.log("This is going to be fun!");`.

Ce code dit à votre ordinateur d'afficher *Ça va être amusant !* dans votre terminal.
...
Nous pouvons maintenant exécuter ce script.
