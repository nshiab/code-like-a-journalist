...
Dans cette leçon, nous prendrons le code final du [calculateur de compte épargne 💸](/data-projects/saving-account-calculator) et le refactoriserons. Si vous n'avez pas fait ce projet, faites-le d'abord ! Je m'attends également à ce que vous ayez terminé toutes les leçons de la section **Fondamentaux de TypeScript** 🧑‍🎓.
