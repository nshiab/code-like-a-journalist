...
By default, Deno doesn’t allow a script to read files on your computer. Again, this is a great security feature. Imagine running an unknown script that reads private files with confidential data!
...
Now your script can write, read, and more!
