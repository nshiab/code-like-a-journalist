...
Cette leçon suppose que vous avez déjà complété les leçons sur les [Données tabulaires](/simple-data-analysis/tabular-data) et les [Données géospatiales](/simple-data-analysis/geospatial).
...
Nous avons beaucoup de pics qui se chevauchent. Par défaut, Plot dessine les pics dans l'ordre dans lequel ils apparaissent dans les données.

Mettons à jour `crunchData` pour trier les feux par ordre croissant de `hectares`, afin que les feux les plus importants soient dessinés en dernier et apparaissent au-dessus des autres.
