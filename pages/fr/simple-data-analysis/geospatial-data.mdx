...
Now that weIn this lesson, we will learn how to use the open-source library I created: [simple-data-analysis](https://github.com/nshiab/simple-data-analysis). We will analyze wildfires in Canadian provinces. The question will answer is:

- How much have wildfires by in each Canadian province in 2023?
