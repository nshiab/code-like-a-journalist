...
Avant de commencer, assurez-vous d'avoir complété les sections **Fondamentaux de TypeScript** et **Travailler avec TypeScript**. Ce projet est conçu pour vous aider à pratiquer tout ce que nous avons couvert jusqu'à présent dans ce cours.
...
Exécutez `deno run --watch --check main.ts`. Ce premier script ne nécessite aucune permission particulière.
