...
In this lesson, we will take the final code from the [Savings account calculator 💸](/saving-account-calculator) and refactor it. If you haven’t done this project, do it first! I also expect that you have completed all the lessons in the **TypeScript fundamentals** 🧑‍🎓 section.
