...
![A screenshot showing an option when installing Deno.](/assets/first-steps/setup/deno-path.png)
...
![A screenshot showing how to set up completions when installing Deno.](/assets/first-steps/setup/deno-completions.png)
...
If you see a white dot instead of a cross on the tab label (as shown in the screenshot below), it means you modified the file but haven't saved it. Make sure to save the file by pressing `CMD` + `S` on Mac or `CTRL` + `S` on PC.
