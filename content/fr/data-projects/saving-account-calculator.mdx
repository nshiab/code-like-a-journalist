...
Bienvenue dans votre premier projet ! Notez que je m'attends à ce que vous ayez terminé les leçons de la section *Fondamentaux de TypeScript*. Si ce n’est pas le cas, [commencez ici](/first-steps/setup).
...
- Combien pourrais-je gagner en plaçant mon argent sur un compte d’épargne ?
