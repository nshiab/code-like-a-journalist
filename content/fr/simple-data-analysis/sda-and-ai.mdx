...
Une fois que vous avez copié votre nouvelle clé API, ouvrez le fichier `.env` créé par `setup-data-project` et collez-la-y. Ajoutez également le modèle que nous utiliserons, qui est `gemini-2.0-flash-lite`.
