...
<Callout type="warning" emoji="⚠️">
  You might need administrator rights. If you are on your work computer and the following steps don't work, try asking your IT department.
</Callout>

## Code editor

Code is just text. There is no magic to it. You can write your code in any text editor, but it's more convenient to use a code editor that comes with many useful features.
...
Now, everything should be properly installed. Type `deno --version` in your terminal and press enter to display your Deno version. You should see something like this!
...
This code tell your computer to log *This is going to be fun!* in your terminal.
