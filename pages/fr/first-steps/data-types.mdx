...
Cette leçon est juste une introduction. Nous approfondirons le sujet lorsque nous coderons des projets plus concrets.
...
Pour vérifier si quelque chose est `undefined` ou `null`, vous pouvez utiliser l'opérateur d'égalité stricte (`===`).
